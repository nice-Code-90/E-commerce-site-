                ...
                <Loader /> : (
                    <Fragment>
                        ...
                        <div className="row f-flex justify-content-around">
                            <div className="col-12 col-lg-5 im-fluid" id="product-image">
                                <Carusel pause='hover'>
                                    {product.images && product.images.map(image => (
                                        <Carusel.Item key={image.public_id}>
                            ...
                            <div className="col-12 col-lg-5 mt-5">
                                ...
                                <button id="review_btn" type="button" className="btn btn-primary mt-4" data-toggle="modal" data-target="#ratingModel">
                                    Submit your review
                                </button>
